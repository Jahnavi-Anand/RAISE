...
It supports compliant equity and revenue‑sharing deals using standard legal templates (no AI‑generated documents).  
The **main** branch contains production‑ready code for the frontend, backend APIs, and CI/CD pipeline.[file:12]  
...
- PostgreSQL with Prisma ORM[file:12]  
...
- Compliance checks for KYC‑verified users[file:12]  
...
- Merges to `main` trigger the full CI/CD deployment.  

---

## 📄 License

This project is for academic/project use. Contact the team for external or commercial reuse.
```
